...
Tengo 19 años y estoy en 4to ciclo de **Ingeniería en Ciencias de la Computación**. Me muevo entre el mundo de los datos y el desarrollo — construyo pipelines ETL, diseño frontends y disfruto resolver problemas reales con código.

Me apasionan especialmente el **análisis de datos** y la **ciberseguridad**, aunque el desarrollo también me engancha cuando el reto es interesante.

Ya tengo experiencia real: he trabajado en **procesos ETL para mi universidad** y participé en parte del desarrollo de un modulo de su **frontend institucional**

**Fuera del código:**
- 🗣️ Inglés B2 — puedo colaborar en entornos internacionales
- 🤝 Habilidades blandas sólidas: comunicación, trabajo en equipo y resolución de conflictos
- 🎯 Liderazgo natural — me siento cómodo coordinando equipos y proyectos
- 🔐 Explorando el mundo de la ciberseguridad como siguiente paso
...
![SQL](https://img.shields.io/badge/SQL-F7931E?style=for-the-badge&logo=postgresql&logoColor=white)
...
> Pipelines, bases de datos, transformación y modelado de datos
...
| Proyecto | Descripción | Stack |
|---|---|---|
| [portfolio-web](https://github.com/jhordycamacas/portfolio-web) | Portafolio personal responsivo con animaciones CSS | HTML · CSS · JS |
| [app-inventario](https://github.com/jhordycamacas/app-inventario) | Aplicación web CRUD con dashboard de métricas | Flask · SQLite · Chart.js |

### 🔍 Análisis & Visualización
> Exploración de datos, reportes y dashboards interactivos

| Proyecto | Descripción | Stack |
|---|---|---|
| [eda-notebook](https://github.com/jhordycamacas/eda-notebook) | Análisis exploratorio con storytelling visual | Python · seaborn · matplotlib |
| [dashboard-rrhh](https://github.com/jhordycamacas/dashboard-rrhh) | Dashboard de métricas de recursos humanos | Power BI · DAX |


### 🛠️ Desarrollo de Software
> Programas, utilidades y prácticas de lógica y algoritmos

| Proyecto | Descripción | Stack |
|---|---|---|
| [sistema-biblioteca](https://github.com/jhordycamacas/sistema-biblioteca) | Sistema de gestión de libros con menú por consola | Java |
| [estructuras-datos](https://github.com/jhordycamacas/estructuras-datos) | Implementación de listas, pilas, colas y árboles | C · C++ |
| [calculadora-cli](https://github.com/jhordycamacas/calculadora-cli) | Calculadora con operaciones avanzadas por terminal | Python |

### 🎓 Ejercicios Académicos
> Proyectos y prácticas desarrollados durante la carrera universitaria
...
### 🧪 Prototipos
> Ideas en construcción — experimentos funcionales que aún evolucionan

| Proyecto | Descripción | Stack |
|---|---|---|
| [prototipo-dashboard](https://github.com/jhordycamacas/prototipo-dashboard) | Primera versión de un dashboard de métricas personales | Python · Flask |
| [prototipo-scraper](https://github.com/jhordycamacas/prototipo-scraper) | Experimento de extracción de datos de sitios web | Python · BeautifulSoup |

### ⭐ Proyectos Personales
> Cosas que hice por curiosidad, no por obligación

| Proyecto | Descripción | Stack |
|---|---|---|
| [proyecto-personal-acuario](https://github.com/jhordycamacas/proyecto-personal) | Web scraper con almacenamiento en BD y alertas automáticas | Python · BeautifulSoup |
...
[![Gmail](https://img.shields.io/badge/Gmail-jhordycamacas9-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:jhordycamacas9@gmail.com)
...
*Hecho con código, café y ganas de aprender · Ecuador 🇪🇨*

![Visitors](https://visitor-badge.laobi.icu/badge?page_id=jhordycamacas.jhordycamacas&left_color=1f6feb&right_color=238636&left_text=Visitas+al+perfil)
